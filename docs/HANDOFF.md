...
0. **구글 포토 사진 2장 대기** (교수 확인, 2026-08-30): ① TE608A(6층)
   ...
   **결론(교수 결정, 2026-08-30): 구글 포토 사진은 교수가 직접 준다** —
   채팅에 파일 업로드(권장, 바로 디스크 도착) 또는 공유 링크 붙여넣기
   (scripts/fetch-shared-album.py로 무인증 수집, 실제 앨범 2개로 검증됨).
   Takeout·상시 앨범 등 자동화 계획은 복잡해서 폐기.
