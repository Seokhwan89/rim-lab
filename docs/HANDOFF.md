...
1. **특허 대표도 잔여분**: 완료 4건 — 준직구동(DE 출원서류 Fig.1),
   ...
   만료 시 재연결 대기 후 재시도.
   ⚠️ **미공개 출원 주의**: 2025~2026 신규 출원(직구동 차동 그리퍼,
   파지제어, 유연핸드 등)의 명세서는 CONFIDENTIAL 표기 + 공개공보 전 —
   도면 게시는 등록·공개된 가족만 하는 것을 원칙으로 함. 준직구동 가족
   대표도는 교수 지시로 게시했으나 공개 전 출원임(교수 재확인 권장).
