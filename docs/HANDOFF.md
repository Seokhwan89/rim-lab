...
- 메일함 소식 반영 (2026-09-25, 교수 선택 1·3·4·5 + arXiv): ①News — 표진우
  ...
  **추가 (2026-09-25, "1245 반영하고 3번도 지금")**: ⑥news.ts — 산학 프로젝트
  챌린지 본선 진출(김도영 석사과정 리드, 예선 3팀 선정, 산업부 미래모빌리티
  핵심기술 R&D 인재양성, 1차 본선 10/26 대전) 게시; 10/26 결과 나오면 후속 뉴스.
  ⑦CV 미국 특허 줄 "US17/919,763 (approved)" → "US12,752,086B2, (2026.10.6)"을
