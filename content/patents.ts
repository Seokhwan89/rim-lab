...
export const patents: Patent[] = [
  ...
  {
    title: 'Flexible robot hand design method',
    titleKo: '유연한 로봇핸드 설계 방법',
    numbers: 'KR 10-2025-0097414',
    year: 2025,
    status: 'filed',
    assignee: 'Sogang University',
    project: 'robotic-hands',
  ...
  {
    title: 'Robot hand actuation mechanism combining a quasi-direct-drive actuator and nonlinear springs',
    titleKo: '준 직구동 구동기와 비선형 스프링을 조합한 로봇 핸드 구동 메커니즘',
    numbers: 'KR 10-2025-0097452',
    year: 2025,
    status: 'filed',
    assignee: 'Sogang University',
    project: 'robotic-hands',
  ...
  },
  {
    ...
    note: 'Registered in JP (2026) and CN (2025); pending elsewhere',
  },
  {
